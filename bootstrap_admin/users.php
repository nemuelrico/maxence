...
$query = "SELECT id, name, email, contact_number, role FROM users";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">User Management Table</h1>
                                ...
                                <tbody>
                                    <?php foreach ($users as $user): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Edit Button (Will link to a separate edit page later) -->
                                                <button onclick="window.location.href='edit_user.php?id=<?php echo $user['id']; ?>'">Edit</button>
                                                <!-- Delete Button (Will call delete functionality) -->
